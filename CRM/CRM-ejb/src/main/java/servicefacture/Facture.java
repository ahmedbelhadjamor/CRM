...
TypedQuery<Bills> query = em.createQuery("select e from Bills e",Bills.class);
	...
	@Override
	public Operator Log(String user, String pwd) {
		// TODO Auto-generated method stub
				try{
					TypedQuery<Operator> q2 = em.createQuery("SELECT u FROM Operator u WHERE u.usernameop = :user AND u.passwordop = :pwd ",Operator.class); 
